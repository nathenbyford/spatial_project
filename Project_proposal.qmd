---
title: "Comparison of models for under reporting in Covid-19 and TB case reporting"
subtitle: "By State"
date: 4/11/2024
date-format: long
...
TB as a more serious disease may not be as under reported and might not benefit from using an under reported model.

It is reasonable to assume there is low under reporting of TB in the US;
...
- Poisson regression
- Using a log link on the Poisson mean[^1]

[^1]: Also called a Poisson-logistic or Pogit regression model
